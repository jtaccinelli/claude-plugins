...
**Report** (returned to the dispatcher): code written to the mapped host location inside the attempt's worktree, ready for the coordinator's [Reviewing Fidelity](../../coordinator/actions/reviewing-fidelity.md) action.
