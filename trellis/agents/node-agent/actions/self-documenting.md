...
**Output**: updated item leaf (`CONTRACT.md`, `USAGE.md`, `CHANGELOG.md`, `REFERENCES.md`), this node's `INVENTORY.md`, and — when a new pattern was logged or a conflict was raised — this node's `AGENT.md`.
