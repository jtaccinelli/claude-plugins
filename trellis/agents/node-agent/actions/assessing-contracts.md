...
description: Check a routed contract against this node's inventory and return a Met / Partial / Unmet / Countered verdict.
---

# Assessing Contracts

**Trigger**: the coordinator routes a contract to this node.

**Inputs**: the contract's required output shape and inputs, this node's `INVENTORY.md`.
