...
6. Regenerate this item's `REFERENCES.md` and this node's `INVENTORY.md` — same generation procedure as Self-Documenting: follow the `Source` pointer, scan imports.
